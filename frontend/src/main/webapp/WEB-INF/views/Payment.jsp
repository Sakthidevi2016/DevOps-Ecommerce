                    ...
                    <div style="padding-top:30px" class="panel-body" >
                        ...
                        <form id="paymentform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                            <input type="radio" name="pmode" value="cc" required> Credit/Debit Card
                                    	    <input type="radio" name="pmode" value="cd" required> Cash on Delivery
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                pattern="[0-9][0-9]/[0-9][0-9][0-9][0-9]" required>
                            </div>
